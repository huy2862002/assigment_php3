...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{asset('dist/img/logo.png')}}" alt="logo" height="99" width="99">
        </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2022 <a href="#">Nguyễn Quang Huy</a>.</strong>
            All rights reserved.
            <div class="float-right d-none d-sm-inline-block">
                <b>FPT Polytechnic</b> K6
            </div>
        </footer>
